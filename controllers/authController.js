...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  // why we can't use User.findByIdAndUpdate
  //bcz pre save middleware which is eencyting password in our database
  // validation to compare confirm and actual password is not going to work
  //bcz this.password is not defined when we update we don't have doc when we are updating
  // don't use update when you want to use this(doc) keyword
